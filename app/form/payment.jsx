...
export const PaymentForm = ({ tenantId, onClose}) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TextInput style={styles.input} value={month} onChangeText={setMonth}  placeholder="e.g. Jan 2025" />

      <Text style={styles.label}>Paid Amount <Text style={{color: 'red'}}>*</Text></Text>
      <TextInput style={styles.input} value={paidAmount} onChangeText={setPaidAmount} keyboardType="numeric" placeholder='ksh.'/>

      <Text style={styles.label}>Electricity</Text>
      <TextInput style={styles.input} value={electricity} onChangeText={setElectricity} keyboardType="numeric" placeholder='ksh.' />

      <Text style={styles.label}>Water</Text>
      <TextInput style={styles.input} value={water} onChangeText={setWater} keyboardType="numeric" placeholder='ksh.'/>

      <Text style={styles.label}>Garbage</Text>
      <TextInput style={styles.input} value={garbage} onChangeText={setGarbage} keyboardType="numeric" placeholder='ksh.'/>
      ...
      <TextInput style={styles.input} value={note} onChangeText={setNote} placeholder="e.g. Month of April" />
    ...
    picker: { marginTop: 4, borderWidth: 1, borderColor: '#ccc' },
